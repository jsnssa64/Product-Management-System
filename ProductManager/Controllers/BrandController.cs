...
namespace ProductManager.Controllers
{
    ...
    public class BrandController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IReadOnlyList<Models.Brand.Brand>> Get() => await _brandRepository.GetAll();

        [HttpGet("GetByProductId/{id}")]
        public async Task<Models.Brand.Brand> GetByProductId(int Id) => await _brandRepository.GetBrandById(Id);

        [HttpPost("Update")]
        public async Task<int> Update([FromBody]UpdateBrand updateBrandDTO)
        {
